        ...
        [
            ...
            'capabilities' => [
                ...
                [
                    ...
                    'name' => 'Кнопка показать описание полностью',
                    'description' => 'На мобильных экранах краткое описание раздела показывается частично и раскрывается по кнопке на любом уровне каталога.',
                    'surface' => 'storefront-mobile',
                    'group' => 'Мобильная версия',
                    'tooltip' => 'Частичное скрытие краткого описания раздела (SEO-описания) и отображение по клику целиком',
                    'defaultEnabled' => true,
                    'mutable' => true,
                    'state' => 'managed',
                    'risk' => 'low',
                    'requiresReload' => true,
                    'optionModule' => 'prospektweb.propvalmanager',
                    'optionName' => 'MOBILE_SECTION_DESCRIPTION_EXPAND',
                    'optionDefault' => 'Y',
                ],
            ],
        ],
