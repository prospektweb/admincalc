        ...
        [
            ...
            'capabilities' => [
                [
                    ...
                    'description' => 'Последовательность списка товаров строится на основе сортировки. Вариант "Сначала популярные" - меньшее значение сортировки, "Сначала непопулярные"- большее значение сортировки.',
                    'surface' => 'storefront',
                    'group' => 'Каталог',
                    'tooltip' => '',
                    'defaultEnabled' => true,
                    ...
                    'optionName' => 'CATALOG_STANDARD_SORTING',
                    'optionDefault' => 'Y',
                ],
                [
                ...
                [
                    'id' => 'mobile.catalog.pagination_containment',
                    'name' => 'Пагинация без горизонтального сдвига страницы',
                    'description' => 'Оставляет широкую пагинацию каталога внутри её контейнера на узких мобильных экранах.',
                    'surface' => 'storefront-mobile',
                    'group' => 'Мобильная версия',
                    'tooltip' => 'Если номера страниц шире экрана, прокрутка работает только внутри пагинации и не сдвигает всю страницу по горизонтали.',
                    'defaultEnabled' => true,
                    'mutable' => true,
                    'state' => 'managed',
                    'risk' => 'low',
                    'requiresReload' => true,
                    'optionModule' => 'prospektweb.storefrontui',
                    'optionName' => 'MOBILE_CATALOG_OVERFLOW_GUARD',
                    'optionDefault' => 'Y',
                ],
                [
