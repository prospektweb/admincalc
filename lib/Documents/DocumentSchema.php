...
final class DocumentSchema
{
    ...
    public static function install(SqlConnection $db): void
    {
        ...
        if ($mysql) {
            ...
            foreach (['b_pw_calc_document', 'b_pw_calc_revision', 'b_pw_calc_publication', 'b_pw_calc_site_publication', 'b_pw_calc_site_active', 'b_pw_calc_site_identity', 'b_pw_calc_product_binding'] as $table) {
