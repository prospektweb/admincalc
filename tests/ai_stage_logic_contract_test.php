...
$checks = [
    ...
    [$gateway, "compatibleModules", 'published module catalog'],
    [$gateway, "moduleAttachment", 'structured module attachment alternative'],
    [$gateway, "previewRequired=true", 'mandatory preview boundary'],
    [$gateway, "Never choose latest", 'exact version boundary'],
    [$gateway, "AiModuleContract::validateProposal", 'shared server-side attachment validation'],
