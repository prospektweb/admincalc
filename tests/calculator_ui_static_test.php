...
$checks = [
    ...
    [$calculator, "index.html?v=3dca78cb8ed7", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=d2124ccdf807", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=d2124ccdf807", 'App HTML must load the current stylesheet without stale asset cache'],
