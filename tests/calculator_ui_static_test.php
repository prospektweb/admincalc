...
$checks = [
    ...
    [$calculator, "index.html?v=9af8fcdeae4d", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=9af8fcdeae4d", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=9af8fcdeae4d", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=9af8fcdeae4d", 'App HTML must load the current stylesheet without stale asset cache'],
