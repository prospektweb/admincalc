...
$checks = [
    ...
    [$calculator, "index.html?v=fad55f2d3c37", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=fad55f2d3c37", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
