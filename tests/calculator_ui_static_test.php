...
$checks = [
    ...
    [$calculator, "index.html?v=b76eac7ae6e2", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=b76eac7ae6e2", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b76eac7ae6e2", 'App HTML must load the current stylesheet without stale asset cache'],
