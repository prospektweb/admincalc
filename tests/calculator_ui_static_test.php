...
$checks = [
    ...
    [$calculator, "index.html?v=4b0f929a8da5", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=4b0f929a8da5", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=4b0f929a8da5", 'App HTML must load the current stylesheet without stale asset cache'],
    ...
    [$installer, 'NativeInstallation', 'Installer delegates to native schema owner'],
