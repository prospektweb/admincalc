...
$checks = [
    ...
    [$calculator, "index.html?v=ec0478cdb6a8", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=ec0478cdb6a8", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=ec0478cdb6a8", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=ec0478cdb6a8", 'Built application HTML must invalidate the stable stylesheet asset name'],
