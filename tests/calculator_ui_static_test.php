...
$checks = [
    ...
    [$calculator, "index.html?v=d7c72c9ef4c2", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=d7c72c9ef4c2", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
