...
$checks = [
    ...
    [$calculator, "index.html?v=470d6f31fd3e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=470d6f31fd3e", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
