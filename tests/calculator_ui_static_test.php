...
$checks = [
    ...
    [$calculator, "index.html?v=41d16eddf3b8", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=41d16eddf3b8", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=41d16eddf3b8", 'App HTML must load the current stylesheet without stale asset cache'],
