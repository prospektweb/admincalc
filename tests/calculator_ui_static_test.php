...
$checks = [
    ...
    [$appIndex, "assets/index.js?v=a52739ba9e65", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=a52739ba9e65", 'App HTML must load the current stylesheet without stale asset cache'],
