...
$checks = [
    ...
    [$calculator, "index.html?v=e2b27e8d0ba6", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=e2b27e8d0ba6", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=e2b27e8d0ba6", 'App HTML must load the current stylesheet without stale asset cache'],
