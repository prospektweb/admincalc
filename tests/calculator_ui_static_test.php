...
$checks = [
    ...
    [$calculator, "index.html?v=3b310b19ac38-ai-clean-default7", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=3b310b19ac38-ai-clean-default7", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=3b310b19ac38", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=3b310b19ac38", 'App HTML must load the current stylesheet without stale asset cache'],
