...
$checks = [
    ...
    [$calculator, "index.html?v=78859da45dee", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=78859da45dee", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=78859da45dee", 'App HTML must load the current stylesheet without stale asset cache'],
