...
$checks = [
    ...
    [$calculator, "index.html?v=2c10bb0b01cd", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=2c10bb0b01cd", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=2c10bb0b01cd", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=2c10bb0b01cd", 'Built application HTML must invalidate the stable stylesheet asset name'],
