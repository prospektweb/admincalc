...
$checks = [
    ...
    [$appIndex, "assets/index.js?v=47c14a07660d", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=47c14a07660d", 'App HTML must load the current stylesheet without stale asset cache'],
