...
$checks = [
    ...
    [$calculator, "index.html?v=c785e9f09a1f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=c785e9f09a1f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=c785e9f09a1f", 'App HTML must load the current stylesheet without stale asset cache'],
