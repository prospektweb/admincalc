...
$checks = [
    ...
    [$calculator, "index.html?v=6f3f60a6c99f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=6f3f60a6c99f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=6f3f60a6c99f", 'App HTML must load the current stylesheet without stale asset cache'],
