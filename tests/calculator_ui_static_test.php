...
$checks = [
    ...
    [$appIndex, "assets/index.js?v=310c3a110c78", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=310c3a110c78", 'App HTML must load the current stylesheet without stale asset cache'],
