...
$checks = [
    ...
    [$calculator, "index.html?v=c8c8a8a1a566", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=c8c8a8a1a566", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=c8c8a8a1a566", 'App HTML must load the current stylesheet without stale asset cache'],
