...
$checks = [
    ...
    [$calculator, "index.html?v=7523d421f7e0", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=7523d421f7e0", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=7523d421f7e0", 'App HTML must load the current stylesheet without stale asset cache'],
