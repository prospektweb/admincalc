...
$checks = [
    ...
    [$calculator, "index.html?v=04965db06cca", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=04965db06cca", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=04965db06cca", 'App HTML must load the current stylesheet without stale asset cache'],
