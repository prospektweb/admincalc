...
$checks = [
    ...
    [$calculator, "index.html?v=88fb55807a7f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=88fb55807a7f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=88fb55807a7f", 'App HTML must load the current stylesheet without stale asset cache'],
