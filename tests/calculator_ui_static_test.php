...
$checks = [
    ...
    [$calculator, "index.html?v=1e8bf48ff009", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=1e8bf48ff009", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=1e8bf48ff009", 'App HTML must load the current stylesheet without stale asset cache'],
