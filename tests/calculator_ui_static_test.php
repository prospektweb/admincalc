...
$checks = [
    ...
    [$calculator, "index.html?v=53e9e4f33e61", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=53e9e4f33e61", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=53e9e4f33e61", 'App HTML must load the current stylesheet without stale asset cache'],
