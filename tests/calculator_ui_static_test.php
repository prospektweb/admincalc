...
$checks = [
    ...
    [$calculator, "index.html?v=c1c338fca07c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=c1c338fca07c", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
