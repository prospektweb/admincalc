...
$checks = [
    ...
    [$calculator, "index.html?v=cde3973ca26c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=cde3973ca26c", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=cde3973ca26c", 'App HTML must load the current stylesheet without stale asset cache'],
