...
$checks = [
    ...
    [$calculator, "index.html?v=59cd516b21ef", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=59cd516b21ef", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=59cd516b21ef", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=59cd516b21ef", 'Built application HTML must invalidate the stable stylesheet asset name'],
