...
$checks = [
    ...
    [$calculator, "index.html?v=e9b6a9e5a96e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=e9b6a9e5a96e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=e9b6a9e5a96e", 'App HTML must load the current stylesheet without stale asset cache'],
