...
$checks = [
    ...
    [$calculator, "index.html?v=e0706972e7e7", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=e0706972e7e7", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=e0706972e7e7", 'App HTML must load the current stylesheet without stale asset cache'],
