...
$checks = [
    ...
    [$calculator, "index.html?v=14f6d20b9519", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=14f6d20b9519", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=14f6d20b9519", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=14f6d20b9519", 'App HTML must load the current stylesheet without stale asset cache'],
