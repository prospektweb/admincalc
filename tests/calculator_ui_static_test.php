...
$checks = [
    ...
    [$calculator, "index.html?v=83c3c2c5e7a2", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=83c3c2c5e7a2", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=83c3c2c5e7a2", 'App HTML must load the current stylesheet without stale asset cache'],
