...
$checks = [
    ...
    [$calculator, "index.html?v=ec0c960a7d81", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ec0c960a7d81", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ec0c960a7d81", 'App HTML must load the current stylesheet without stale asset cache'],
