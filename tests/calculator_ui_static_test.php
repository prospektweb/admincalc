...
$checks = [
    ...
    [$calculator, "index.html?v=a52739ba9e65", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=13589aa7a7f0", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=13589aa7a7f0", 'App HTML must load the current stylesheet without stale asset cache'],
