...
$checks = [
    ...
    [$calculator, "index.html?v=93626108bdc3", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=93626108bdc3", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=93626108bdc3", 'App HTML must load the current stylesheet without stale asset cache'],
    ...
    [$integration, 'window.BX && window.BX.SidePanel && window.BX.SidePanel.Instance', 'The form editor must prefer the current Bitrix slider context so it stays visible above the material tree'],
    [$integration, 'hostWindow.BX.SidePanel.Instance', 'The form editor must open as a native Bitrix slider above the material tree'],
    ...
    [$integration, "this.sendPwrtMessage('INIT', refreshedInitData, message.requestId, origin)", 'Catalog metadata saves must publish the refreshed entity catalog to the iframe'],
