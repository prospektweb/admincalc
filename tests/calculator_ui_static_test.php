...
$checks = [
    ...
    [$calculator, "index.html?v=f37d45ca9f4c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=f37d45ca9f4c", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=f37d45ca9f4c", 'App HTML must load the current stylesheet without stale asset cache'],
