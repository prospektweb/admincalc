...
$checks = [
    ...
    [$calculator, "index.html?v=c97bbedb5405", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=c97bbedb5405", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=c97bbedb5405", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=c97bbedb5405", 'App HTML must load the current stylesheet without stale asset cache'],
