...
$checks = [
    ...
    [$calculator, "index.html?v=1bdc823f03aa", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=1bdc823f03aa", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=1bdc823f03aa", 'App HTML must load the current stylesheet without stale asset cache'],
