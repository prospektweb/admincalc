...
$checks = [
    ...
    [$calculator, "index.html?v=edc0836cd764", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=edc0836cd764", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=edc0836cd764", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=edc0836cd764", 'App HTML must load the current stylesheet without stale asset cache'],
