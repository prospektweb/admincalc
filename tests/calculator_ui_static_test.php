...
$checks = [
    ...
    [$calculator, "index.html?v=562b57ee1bdc", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=562b57ee1bdc", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=562b57ee1bdc", 'App HTML must load the current stylesheet without stale asset cache'],
