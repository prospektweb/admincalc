...
$checks = [
    ...
    [$calculator, "index.html?v=81dab3fed0c9", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=81dab3fed0c9", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
