...
$checks = [
    ...
    [$calculator, "index.html?v=35e5e27d2234", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=35e5e27d2234", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
