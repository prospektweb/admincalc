...
$checks = [
    ...
    [$calculator, "index.html?v=efd255c6c304", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=efd255c6c304", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=efd255c6c304", 'App HTML must load the current stylesheet without stale asset cache'],
