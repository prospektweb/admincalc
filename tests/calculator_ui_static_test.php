...
$checks = [
    ...
    [$calculator, "index.html?v=d8e242e5a8af", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=d8e242e5a8af", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=d8e242e5a8af", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=d8e242e5a8af", 'App HTML must load the current stylesheet without stale asset cache'],
