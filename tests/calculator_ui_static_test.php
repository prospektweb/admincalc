...
$checks = [
    ...
    [$calculator, "index.html?v=6c87f66274c0", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=6c87f66274c0", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
