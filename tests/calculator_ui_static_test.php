...
$checks = [
    ...
    [$calculator, "index.html?v=2323e5c183ad", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=2323e5c183ad", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
