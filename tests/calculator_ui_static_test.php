...
$checks = [
    ...
    [$calculator, "index.html?v=bc79bef096d5", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=bc79bef096d5", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=bc79bef096d5", 'App HTML must load the current stylesheet without stale asset cache'],
