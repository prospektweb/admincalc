...
$checks = [
    ...
    [$calculator, "index.html?v=bb04afd6b509", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=bb04afd6b509", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=bb04afd6b509", 'App HTML must load the current stylesheet without stale asset cache'],
