...
$checks = [
    ...
    [$calculator, "index.html?v=46b12ef40c2c-global-kind", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=46b12ef40c2c-global-kind", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=46b12ef40c2c", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=46b12ef40c2c", 'App HTML must load the current stylesheet without stale asset cache'],
