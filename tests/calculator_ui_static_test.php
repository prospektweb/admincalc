...
$checks = [
    ...
    [$calculator, "index.html?v=fbc8d5d42394", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fbc8d5d42394", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fbc8d5d42394", 'App HTML must load the current stylesheet without stale asset cache'],
