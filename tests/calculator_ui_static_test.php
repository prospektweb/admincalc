...
$checks = [
    ...
    [$calculator, "index.html?v=c497e81b2ce8", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=c497e81b2ce8", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=c497e81b2ce8", 'App HTML must load the current stylesheet without stale asset cache'],
