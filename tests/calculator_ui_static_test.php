...
$checks = [
    ...
    [$calculator, "index.html?v=36d30b7ea30f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=36d30b7ea30f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=36d30b7ea30f", 'App HTML must load the current stylesheet without stale asset cache'],
    ...
    [$calculatorAjax, 'preparePresetPayload($presetId, $siteId)', 'INIT endpoint must dispatch product-neutral preset launches'],
