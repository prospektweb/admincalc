...
$checks = [
    ...
    [$calculator, "index.html?v=1c1c82548357", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=1c1c82548357", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
