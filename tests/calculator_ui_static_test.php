...
$checks = [
    ...
    [$calculator, "index.html?v=ec41565e4a1e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ec41565e4a1e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ec41565e4a1e", 'App HTML must load the current stylesheet without stale asset cache'],
