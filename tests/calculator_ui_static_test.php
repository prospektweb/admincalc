...
$checks = [
    ...
    [$calculator, "index.html?v=cf0534c25219", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=cf0534c25219", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=cf0534c25219", 'App HTML must load the current stylesheet without stale asset cache'],
