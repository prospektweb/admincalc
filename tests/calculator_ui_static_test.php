...
$checks = [
    ...
    [$calculator, "index.html?v=cf56fc1d196f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=cf56fc1d196f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=cf56fc1d196f", 'App HTML must load the current stylesheet without stale asset cache'],
