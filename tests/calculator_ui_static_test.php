...
$checks = [
    ...
    [$calculator, "index.html?v=b38bdf96f5d4", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=b38bdf96f5d4", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b38bdf96f5d4", 'App HTML must load the current stylesheet without stale asset cache'],
