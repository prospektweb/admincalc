...
$checks = [
    ...
    [$calculator, "index.html?v=115d457cadda", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=115d457cadda", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=115d457cadda", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=115d457cadda", 'App HTML must load the current stylesheet without stale asset cache'],
