...
$checks = [
    ...
    [$calculator, "index.html?v=811f5108f9f0", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=811f5108f9f0", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=811f5108f9f0", 'App HTML must load the current stylesheet without stale asset cache'],
