...
$checks = [
    ...
    [$calculator, "index.html?v=95e753b763f2", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=95e753b763f2", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=95e753b763f2", 'App HTML must load the current stylesheet without stale asset cache'],
