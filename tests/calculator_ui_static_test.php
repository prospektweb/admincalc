...
$checks = [
    ...
    [$calculator, "index.html?v=ffc522699719", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=ffc522699719", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=ffc522699719", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=ffc522699719", 'Built application HTML must invalidate the stable stylesheet asset name'],
