...
$checks = [
    ...
    [$calculator, "index.html?v=2bed307a7b10", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=2bed307a7b10", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
