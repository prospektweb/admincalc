...
$checks = [
    ...
    [$calculator, "index.html?v=902315add19b", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=902315add19b", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=902315add19b", 'App HTML must load the current stylesheet without stale asset cache'],
