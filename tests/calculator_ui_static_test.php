...
$checks = [
    ...
    [$calculator, "index.html?v=eb1d0f50bbec", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=eb1d0f50bbec", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=eb1d0f50bbec", 'App HTML must load the current stylesheet without stale asset cache'],
