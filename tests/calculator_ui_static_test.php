...
$checks = [
    ...
    [$calculator, "index.html?v=a141c24151df", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=a141c24151df", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=a141c24151df", 'App HTML must load the current stylesheet without stale asset cache'],
