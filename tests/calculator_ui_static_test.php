...
$checks = [
    ...
    [$calculator, "index.html?v=ce9d23d9489b", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=ce9d23d9489b", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=ce9d23d9489b", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ce9d23d9489b", 'App HTML must load the current stylesheet without stale asset cache'],
