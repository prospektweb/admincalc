...
$checks = [
    ...
    [$calculator, "index.html?v=49d05545130b", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=49d05545130b", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=49d05545130b", 'App HTML must load the current stylesheet without stale asset cache'],
