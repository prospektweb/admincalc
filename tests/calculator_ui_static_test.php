...
$checks = [
    ...
    [$calculator, "index.html?v=8b4b0d7817db", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=8b4b0d7817db", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=8b4b0d7817db", 'App HTML must load the current stylesheet without stale asset cache'],
