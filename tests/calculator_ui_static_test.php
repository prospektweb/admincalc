...
$checks = [
    ...
    [$calculator, "index.html?v=e6f944d2b41a-assets1", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=e6f944d2b41a-assets1", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
