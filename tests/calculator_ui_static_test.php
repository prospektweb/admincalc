...
$checks = [
    ...
    [$calculator, "index.html?v=306a7f349c85", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=306a7f349c85", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=306a7f349c85", 'App HTML must load the current stylesheet without stale asset cache'],
