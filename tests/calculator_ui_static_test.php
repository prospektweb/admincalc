...
$checks = [
    ...
    [$calculator, "index.html?v=f5aa7864f5d1", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=f5aa7864f5d1", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=f5aa7864f5d1", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=f5aa7864f5d1", 'App HTML must load the current stylesheet without stale asset cache'],
