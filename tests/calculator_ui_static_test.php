...
$checks = [
    ...
    [$calculator, "index.html?v=52bd828cfa09", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=52bd828cfa09", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=52bd828cfa09", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=52bd828cfa09", 'Built application HTML must invalidate the stable stylesheet asset name'],
