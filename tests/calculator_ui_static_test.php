...
$checks = [
    ...
    [$calculator, "index.html?v=a84805b0a2fd", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=a84805b0a2fd", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=a84805b0a2fd", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=a84805b0a2fd", 'Built application HTML must invalidate the stable stylesheet asset name'],
