...
$checks = [
    ...
    [$calculator, "index.html?v=4054a077615b", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=4054a077615b", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
