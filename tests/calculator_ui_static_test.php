...
$checks = [
    ...
    [$calculator, "index.html?v=4c88927bc7b8", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=4c88927bc7b8", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
