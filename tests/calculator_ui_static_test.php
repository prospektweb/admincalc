...
$checks = [
    ...
    [$calculator, "index.html?v=fdf02e46503f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fdf02e46503f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fdf02e46503f", 'App HTML must load the current stylesheet without stale asset cache'],
