...
$checks = [
    ...
    [$calculator, "index.html?v=cfaa9cf67d08", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=cfaa9cf67d08", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
