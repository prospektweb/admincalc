...
$checks = [
    ...
    [$calculator, "index.html?v=33ec9378dd7a", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=33ec9378dd7a", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=33ec9378dd7a", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=33ec9378dd7a", 'App HTML must load the current stylesheet without stale asset cache'],
