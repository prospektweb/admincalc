...
$checks = [
    ...
    [$calculator, "index.html?v=d4813141ed0e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=d4813141ed0e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=d4813141ed0e", 'App HTML must load the current stylesheet without stale asset cache'],
