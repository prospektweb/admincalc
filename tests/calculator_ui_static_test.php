...
$checks = [
    ...
    [$calculator, "index.html?v=d3759c619d0b", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=d3759c619d0b", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=d3759c619d0b", 'App HTML must load the current stylesheet without stale asset cache'],
