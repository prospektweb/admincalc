...
$checks = [
    ...
    [$calculator, "index.html?v=071bed38a12d", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=071bed38a12d", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=071bed38a12d", 'App HTML must load the current stylesheet without stale asset cache'],
