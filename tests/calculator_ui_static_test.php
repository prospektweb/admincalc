...
$checks = [
    ...
    [$calculator, "index.html?v=92917ee7106f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=92917ee7106f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=92917ee7106f", 'App HTML must load the current stylesheet without stale asset cache'],
