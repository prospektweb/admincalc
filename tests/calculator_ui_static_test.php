...
$checks = [
    ...
    [$calculator, "index.html?v=75f240e1435e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=75f240e1435e", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=75f240e1435e", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=75f240e1435e", 'Built application HTML must invalidate the stable stylesheet asset name'],
