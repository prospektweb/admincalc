...
$checks = [
    ...
    [$calculator, "index.html?v=fd6df685b869", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fd6df685b869", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fd6df685b869", 'App HTML must load the current stylesheet without stale asset cache'],
