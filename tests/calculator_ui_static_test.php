...
$checks = [
    ...
    [$calculator, "index.html?v=611cc0f051ad", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=611cc0f051ad", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=611cc0f051ad", 'App HTML must load the current stylesheet without stale asset cache'],
