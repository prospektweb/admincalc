...
$checks = [
    ...
    [$calculator, "index.html?v=44deb2cf0bba", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=44deb2cf0bba", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=44deb2cf0bba", 'App HTML must load the current stylesheet without stale asset cache'],
