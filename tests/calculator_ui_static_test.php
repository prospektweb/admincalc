...
$checks = [
    ...
    [$calculator, "index.html?v=eb098a15379e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=eb098a15379e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=eb098a15379e", 'App HTML must load the current stylesheet without stale asset cache'],
