...
$checks = [
    ...
    [$calculator, "index.html?v=3f07bd706a22", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=3f07bd706a22", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
