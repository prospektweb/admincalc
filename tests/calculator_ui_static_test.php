...
$checks = [
    ...
    [$calculator, "index.html?v=feb429873324", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=feb429873324", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=feb429873324", 'App HTML must load the current stylesheet without stale asset cache'],
