...
$checks = [
    ...
    [$calculator, "index.html?v=6b775be0e1b3", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=6b775be0e1b3", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=6b775be0e1b3", 'App HTML must load the current stylesheet without stale asset cache'],
