...
$checks = [
    ...
    [$calculator, "index.html?v=2f4d95387c63", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=2f4d95387c63", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=2f4d95387c63", 'App HTML must load the current stylesheet without stale asset cache'],
