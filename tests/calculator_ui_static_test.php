...
$checks = [
    ...
    [$calculator, "index.html?v=bc3758a4b6c5", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=bc3758a4b6c5", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=bc3758a4b6c5", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=bc3758a4b6c5", 'App HTML must load the current stylesheet without stale asset cache'],
