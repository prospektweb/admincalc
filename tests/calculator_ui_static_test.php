...
$checks = [
    ...
    [$calculator, "index.html?v=c3013c42fd10", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=c3013c42fd10", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=c3013c42fd10", 'App HTML must load the current stylesheet without stale asset cache'],
