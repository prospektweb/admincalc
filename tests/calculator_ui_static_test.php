...
$checks = [
    ...
    [$calculator, "index.html?v=b5464a006ac7", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=b5464a006ac7", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b5464a006ac7", 'App HTML must load the current stylesheet without stale asset cache'],
