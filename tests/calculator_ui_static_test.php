...
$checks = [
    ...
    [$calculator, "index.html?v=49b40b6042ad", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=49b40b6042ad", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=49b40b6042ad", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=49b40b6042ad", 'App HTML must load the current stylesheet without stale asset cache'],
