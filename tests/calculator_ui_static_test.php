...
$checks = [
    ...
    [$calculator, "index.html?v=a0684a6f612e-ai-globals5", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=a0684a6f612e-ai-globals5", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=a0684a6f612e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=a0684a6f612e", 'App HTML must load the current stylesheet without stale asset cache'],
