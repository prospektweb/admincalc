...
$checks = [
    ...
    [$calculator, "index.html?v=23c0ee322c72", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=23c0ee322c72", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    ...
    [$appBundle, 'stage-activation-mode-switch', 'Stage settings must support multi-value AND/OR activation'],
