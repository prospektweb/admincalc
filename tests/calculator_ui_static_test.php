...
$checks = [
    ...
    [$calculator, "index.html?v=bc6d5d021dc8", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=bc6d5d021dc8", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=bc6d5d021dc8", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=bc6d5d021dc8", 'Built application HTML must invalidate the stable stylesheet asset name'],
