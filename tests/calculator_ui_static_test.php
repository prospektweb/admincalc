...
$checks = [
    ...
    [$calculator, "index.html?v=be99b7bbe5e4", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=be99b7bbe5e4", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=be99b7bbe5e4", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=be99b7bbe5e4", 'App HTML must load the current stylesheet without stale asset cache'],
