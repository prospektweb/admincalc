...
$checks = [
    ...
    [$calculator, "index.html?v=7de1209d42c4-ai-reliable2", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=7de1209d42c4-ai-reliable2", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=7de1209d42c4", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=7de1209d42c4", 'App HTML must load the current stylesheet without stale asset cache'],
