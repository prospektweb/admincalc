...
$checks = [
    ...
    [$calculator, "index.html?v=75fcd8e17b25", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=75fcd8e17b25", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=75fcd8e17b25", 'App HTML must load the current stylesheet without stale asset cache'],
