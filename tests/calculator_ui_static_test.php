...
$checks = [
    ...
    [$calculator, "index.html?v=62b04fb55940", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=62b04fb55940", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
