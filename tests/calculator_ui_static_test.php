...
$checks = [
    ...
    [$calculator, "index.html?v=408f1d3c0c22", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=408f1d3c0c22", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=408f1d3c0c22", 'App HTML must load the current stylesheet without stale asset cache'],
