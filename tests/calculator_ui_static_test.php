...
$checks = [
    ...
    [$calculator, "index.html?v=63347eaa92de-ai-literal4", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=63347eaa92de-ai-literal4", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=63347eaa92de", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=63347eaa92de", 'App HTML must load the current stylesheet without stale asset cache'],
