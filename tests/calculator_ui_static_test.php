...
$checks = [
    ...
    [$calculator, "index.html?v=f8a2c8c5be29", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=f8a2c8c5be29", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
