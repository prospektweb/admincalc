...
$checks = [
    ...
    [$calculator, "index.html?v=92a69bccb54d", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=92a69bccb54d", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=92a69bccb54d", 'App HTML must load the current stylesheet without stale asset cache'],
