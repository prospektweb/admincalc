...
$checks = [
    ...
    [$calculator, "index.html?v=9e922f02f19f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=9e922f02f19f", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
