...
$checks = [
    ...
    [$calculator, "index.html?v=fb1db22f49f7", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fb1db22f49f7", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fb1db22f49f7", 'App HTML must load the current stylesheet without stale asset cache'],
