...
$checks = [
    ...
    [$calculator, "index.html?v=0c53f7a16067", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=0c53f7a16067", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
