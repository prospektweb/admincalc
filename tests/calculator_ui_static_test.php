...
$checks = [
    ...
    [$calculator, "index.html?v=935f5dc3e4ca", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=935f5dc3e4ca", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=935f5dc3e4ca", 'App HTML must load the current stylesheet without stale asset cache'],
