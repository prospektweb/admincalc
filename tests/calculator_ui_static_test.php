...
$checks = [
    ...
    [$calculator, "index.html?v=85f176dbd4be", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=85f176dbd4be", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=85f176dbd4be", 'App HTML must load the current stylesheet without stale asset cache'],
