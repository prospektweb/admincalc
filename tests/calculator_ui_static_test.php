...
$checks = [
    ...
    [$calculator, "index.html?v=c454fca6deba", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=c454fca6deba", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=c454fca6deba", 'App HTML must load the current stylesheet without stale asset cache'],
