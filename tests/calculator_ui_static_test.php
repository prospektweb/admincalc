...
$checks = [
    ...
    [$calculator, "index.html?v=155d1a3a6750", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=155d1a3a6750", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=155d1a3a6750", 'App HTML must load the current stylesheet without stale asset cache'],
