...
$checks = [
    ...
    [$calculator, "index.html?v=8d63526c3254", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=8d63526c3254", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=8d63526c3254", 'App HTML must load the current stylesheet without stale asset cache'],
