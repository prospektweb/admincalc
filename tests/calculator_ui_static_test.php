...
$checks = [
    ...
    [$calculator, "index.html?v=ddf30cc37273", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ddf30cc37273", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ddf30cc37273", 'App HTML must load the current stylesheet without stale asset cache'],
