...
$checks = [
    ...
    [$calculator, "index.html?v=19e6a4fc5e2f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=19e6a4fc5e2f", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=19e6a4fc5e2f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=19e6a4fc5e2f", 'App HTML must load the current stylesheet without stale asset cache'],
