...
$checks = [
    ...
    [$calculator, "index.html?v=fa6953d1ed9a", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fa6953d1ed9a", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fa6953d1ed9a", 'App HTML must load the current stylesheet without stale asset cache'],
