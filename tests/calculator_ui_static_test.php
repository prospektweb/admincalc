...
$checks = [
    ...
    [$calculator, "index.html?v=a7687a3e2652", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=a7687a3e2652", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=a7687a3e2652", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=a7687a3e2652", 'Built application HTML must invalidate the stable stylesheet asset name'],
