...
$checks = [
    ...
    [$calculator, "index.html?v=3f0f89d93bfa", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=3f0f89d93bfa", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=3f0f89d93bfa", 'App HTML must load the current stylesheet without stale asset cache'],
