...
$checks = [
    ...
    [$calculator, "index.html?v=ed5b0294acd2", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ed5b0294acd2", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ed5b0294acd2", 'App HTML must load the current stylesheet without stale asset cache'],
