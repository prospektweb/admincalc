...
$checks = [
    ...
    [$calculator, "index.html?v=29ea01fcbe54", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=29ea01fcbe54", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
