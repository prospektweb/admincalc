...
$checks = [
    ...
    [$calculator, "index.html?v=636f2b5c0224", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=636f2b5c0224", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=636f2b5c0224", 'App HTML must load the current stylesheet without stale asset cache'],
