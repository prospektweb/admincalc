...
$checks = [
    ...
    [$calculator, "index.html?v=a1d32a9f7f51", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=a1d32a9f7f51", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=a1d32a9f7f51", 'App HTML must load the current stylesheet without stale asset cache'],
