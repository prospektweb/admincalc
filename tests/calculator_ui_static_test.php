...
$checks = [
    ...
    [$calculator, "index.html?v=e78c853f7644", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=e78c853f7644", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=e78c853f7644", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=e78c853f7644", 'App HTML must load the current stylesheet without stale asset cache'],
