...
$checks = [
    ...
    [$calculator, "index.html?v=a3149ba3b0d8", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=a3149ba3b0d8", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=a3149ba3b0d8", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=a3149ba3b0d8", 'App HTML must load the current stylesheet without stale asset cache'],
