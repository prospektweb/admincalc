...
$checks = [
    ...
    [$calculator, "index.html?v=fccac313f243", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fccac313f243", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fccac313f243", 'App HTML must load the current stylesheet without stale asset cache'],
