...
$checks = [
    ...
    [$calculator, "index.html?v=2a36c7fb7596", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=2a36c7fb7596", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=2a36c7fb7596", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=2a36c7fb7596", 'Built application HTML must invalidate the stable stylesheet asset name'],
