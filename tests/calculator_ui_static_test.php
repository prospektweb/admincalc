...
$checks = [
    ...
    [$calculator, "index.html?v=ce84334cc408", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=ce84334cc408", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
