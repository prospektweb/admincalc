...
$checks = [
    ...
    [$calculator, "index.html?v=7b7ee38e9764", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=7b7ee38e9764", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=7b7ee38e9764", 'App HTML must load the current stylesheet without stale asset cache'],
