...
$checks = [
    ...
    [$calculator, "index.html?v=e79d81404c3e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=e79d81404c3e", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
