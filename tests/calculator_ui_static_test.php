...
$checks = [
    ...
    [$calculator, "index.html?v=712c5773314f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=712c5773314f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=712c5773314f", 'App HTML must load the current stylesheet without stale asset cache'],
