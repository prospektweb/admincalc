...
$checks = [
    ...
    [$calculator, "index.html?v=ee52179bf960", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ee52179bf960", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ee52179bf960", 'App HTML must load the current stylesheet without stale asset cache'],
