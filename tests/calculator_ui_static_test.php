...
$checks = [
    ...
    [$calculator, "index.html?v=ad6c306031bb", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=ad6c306031bb", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=ad6c306031bb", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=ad6c306031bb", 'Built application HTML must invalidate the stable stylesheet asset name'],
