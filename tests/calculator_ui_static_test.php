...
$checks = [
    ...
    [$calculator, "index.html?v=f43f92f97dfb", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=f43f92f97dfb", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=f43f92f97dfb", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=f43f92f97dfb", 'App HTML must load the current stylesheet without stale asset cache'],
