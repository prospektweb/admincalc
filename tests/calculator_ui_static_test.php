...
$checks = [
    ...
    [$calculator, "index.html?v=f4e2300793ba", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=f4e2300793ba", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
