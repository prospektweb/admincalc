...
$checks = [
    ...
    [$calculator, "index.html?v=f62209bd65f4", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=f62209bd65f4", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=f62209bd65f4", 'App HTML must load the current stylesheet without stale asset cache'],
