...
$checks = [
    ...
    [$calculator, "index.html?v=22af4955834e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=22af4955834e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=22af4955834e", 'App HTML must load the current stylesheet without stale asset cache'],
