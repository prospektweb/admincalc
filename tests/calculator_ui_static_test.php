...
$checks = [
    ...
    [$calculator, "index.html?v=fa6b48ebca08", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=fa6b48ebca08", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=fa6b48ebca08", 'App HTML must load the current stylesheet without stale asset cache'],
