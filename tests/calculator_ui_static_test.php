...
$checks = [
    ...
    [$calculator, "index.html?v=c6689ed3407c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=c6689ed3407c", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=c6689ed3407c", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=c6689ed3407c", 'Built application HTML must invalidate the stable stylesheet asset name'],
