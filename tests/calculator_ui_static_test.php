...
$checks = [
    ...
    [$calculator, "index.html?v=f6a963c44598", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=f6a963c44598", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=f6a963c44598", 'App HTML must load the current stylesheet without stale asset cache'],
