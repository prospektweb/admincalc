...
$checks = [
    ...
    [$calculator, "index.html?v=ec48ad91859a", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ec48ad91859a", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ec48ad91859a", 'App HTML must load the current stylesheet without stale asset cache'],
