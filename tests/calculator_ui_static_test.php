...
$checks = [
    ...
    [$calculator, "index.html?v=b06d711e8f29-ai-global-validation6", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=b06d711e8f29-ai-global-validation6", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=b06d711e8f29", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b06d711e8f29", 'App HTML must load the current stylesheet without stale asset cache'],
    ...
    [$calculatorPage, '\\CCatalogSku::GetProductInfo', 'Standalone calculator must resolve the product that owns the selected offers'],
