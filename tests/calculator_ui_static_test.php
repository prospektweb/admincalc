...
$checks = [
    ...
    [$calculator, "index.html?v=5fc1a91c8e8a", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=5fc1a91c8e8a", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=5fc1a91c8e8a", 'App HTML must load the current stylesheet without stale asset cache'],
