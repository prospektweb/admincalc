...
$checks = [
    ...
    [$calculator, "index.html?v=a6f7e7b49130", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=a6f7e7b49130", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=a6f7e7b49130", 'App HTML must load the current stylesheet without stale asset cache'],
