...
$checks = [
    ...
    [$calculator, "index.html?v=75c354b3df56", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=75c354b3df56", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
