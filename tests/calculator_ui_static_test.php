...
$checks = [
    ...
    [$calculator, "index.html?v=e3030e6ffbe9", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=e3030e6ffbe9", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=e3030e6ffbe9", 'App HTML must load the current stylesheet without stale asset cache'],
