...
$checks = [
    ...
    [$calculator, "index.html?v=ec99fac8280f", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=ec99fac8280f", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=ec99fac8280f", 'App HTML must load the current stylesheet without stale asset cache'],
