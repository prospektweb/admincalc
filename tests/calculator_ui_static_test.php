...
$checks = [
    ...
    [$calculator, "index.html?v=2b0acee42760", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=2b0acee42760", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=2b0acee42760", 'App HTML must load the current stylesheet without stale asset cache'],
