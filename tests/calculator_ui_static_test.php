...
$checks = [
    ...
    [$calculator, "index.html?v=b3f2f4fa428b", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=b3f2f4fa428b", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b3f2f4fa428b", 'App HTML must load the current stylesheet without stale asset cache'],
