...
$checks = [
    ...
    [$calculator, "index.html?v=5b2a3cc56c63", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=5b2a3cc56c63", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=5b2a3cc56c63", 'App HTML must load the current stylesheet without stale asset cache'],
