...
$checks = [
    ...
    [$calculator, "index.html?v=bf2a18163412", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=bf2a18163412", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=bf2a18163412", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=bf2a18163412", 'App HTML must load the current stylesheet without stale asset cache'],
