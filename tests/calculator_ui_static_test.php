...
$checks = [
    ...
    [$calculator, "index.html?v=b4c16c614d5a", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=b4c16c614d5a", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b4c16c614d5a", 'App HTML must load the current stylesheet without stale asset cache'],
