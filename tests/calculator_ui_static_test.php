...
$checks = [
    ...
    [$calculator, "index.html?v=8c0b3010af28", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    [$calculatorPage, "index.html?v=8c0b3010af28", 'Standalone calculator page must load the current frontend release without stale HTML cache'],
    [$appIndex, "assets/index.js?v=8c0b3010af28", 'Built application HTML must invalidate the stable JavaScript asset name'],
    [$appIndex, "assets/style.css?v=8c0b3010af28", 'Built application HTML must invalidate the stable stylesheet asset name'],
