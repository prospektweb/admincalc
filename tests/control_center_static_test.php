...
$assert(preg_match('~assets/index\.js\?v=([a-f0-9]{12})(?![a-f0-9])~', $appIndex, $releaseMatch) === 1
    && strpos($contextualCalculator, 'index.html?v=' . $releaseMatch[1]) !== false
    && strpos($appIndex, 'assets/style.css?v=' . $releaseMatch[1]) !== false,
    'The control center ships a consistently versioned calcconfig release');
